          ...
          <div className="mt-6 space-y-2">
            <div className="text-center">
              <p className="text-sm text-slate-600">
                ...
                <Link to="/register" className="font-medium text-slate-900 hover:text-slate-700 underline">
                  Sign up here
                </Link>
              </p>
            </div>
            <div className="border-t border-slate-200 pt-4">
              <p className="text-xs text-slate-500 text-center">Try: admin@example.com</p>
            </div>
          </div>
        </div>
      </div>
